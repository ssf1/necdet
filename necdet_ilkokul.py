...
def csv_ayirici():
    with open('ilkokul_listesi.csv', "r") as liste:
...
with open("ilkokul_ogrenci.html", "w") as ogr:
    print (
        """
<html>
<head>
    <meta charset="utf-8">
    <title>İlkokul Öğrenci yaka kartları </title>
...
with open("ilkokul_danisman.html", "w") as dan:
    print (
        """
<html>
<head>
    <meta charset="utf-8">
    <title>İlkokul Danışman yaka kartları </title>
    <link rel = "stylesheet" href="style.css" type = "text/css" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="google-site-verification" content="z-50L0HFIXAJjH6yeYrnQIRhy6-cNnQkvCZo1ZdkgL0" />
    <!--[if IE]>
